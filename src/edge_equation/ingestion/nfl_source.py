...
class NflSource:
    ...
    def get_raw_markets(self, run_datetime: datetime) -> list:
        ...
        for g in games:
            ...
            # Spread emitted as two outcomes: home -3.5 and away +3.5.
            # Selections are bare team names; the line lives on
            # MarketInfo.line so _resolve_selection_side can exact-match.
            sp_inputs = {"strength_home": 1.28, "strength_away": 1.14, "home_adv": 0.115}
            sp_univ = {"home_edge": 0.07}
            markets.append({
                "game_id": gid, "market_type": "Spread", "selection": home,
                "line": Decimal("-3.5"), "odds": -110,
